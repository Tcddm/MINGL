...
void *mgl_slider_init(void *memory,const void *args){
    ...
    MGL_WIDGET_FIELD_HANDLE_DEFAULT(s,sa,max,MGL_SLIDER_DEFAULT_MAX);
    MGL_WIDGET_FIELD_HANDLE_DEFAULT(s,sa,track_h,MGL_SLIDER_DEFAULT_TRACK_H);
    MGL_WIDGET_FIELD_HANDLE_DEFAULT(s,sa,thumb_w,MGL_SLIDER_DEFAULT_THUMB_H);
    MGL_WIDGET_FIELD_HANDLE_DEFAULT(s,sa,thumb_h,MGL_SLIDER_DEFAULT_THUMB_H);

    s->dragging=false;

    MGL_WIDGET_BASE_FIELD_HANDLE(s,sa);
    MGL_WIDGET_ROUND_RADIUS_FIELD_HANDLE(s,sa);
    MGL_WIDGET_PAINTER_FIELD_HANDLE_NAME_DEFAULT(s,sa,track,MGL_THEME_TRACK());
    MGL_WIDGET_PAINTER_FIELD_HANDLE_NAME_DEFAULT(s,sa,fill,MGL_THEME_ACCENT());
    MGL_WIDGET_PAINTER_FIELD_HANDLE_NAME_DEFAULT(s,sa,thumb,MGL_THEME_BG());
